Feat: Completed an unfinished suite of tests using the Jasmine library to test functionality and certain features of a web application that reads RSS feeds.
